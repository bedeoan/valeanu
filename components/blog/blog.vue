      ...
      <section class="relative md:py-24 py-16" id="blog">
            <div class="container">
                <div class="grid grid-cols-1 pb-8 text-center">
                    <h6 class="text-yellow-600 text-base font-medium uppercase mb-2">Blogs</h6>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-6 mt-8">
                    <div v-for="item in blogs" :key="item" class="blog relative rounded-md shadow shadow-slate-200 dark:shadow-slate-800 overflow-hidden">
                        ...
                        <div class="content p-6">
                            <NuxtLink to="/blog-detail" class="text-lg hover:text-yellow-600 dark:text-white dark:hover:text-yellow-600 transition-all duration-500 ease-in-out font-medium">{{item.title}}</NuxtLink>
                            <p class="text-slate-400 mt-3">{{ item.desc }}</p>
                            
                            <div class="mt-5">
                                <NuxtLink to="/blog-detail"  class="btn btn-link hover:text-yellow-600 dark:hover:text-yellow-600 after:bg-orange-600 dark:text-white transition duration-500">Read More <i class="uil uil-arrow-right"></i></NuxtLink >
                            </div>
                        </div>
                    </div>
                </div><!--end grid-->
